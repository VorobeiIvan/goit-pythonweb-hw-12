...
def test_contact_create_valid_data():
    ...
    valid_data = {
        ...
        "phone": "1234567890",
        "birthday": date.today() - timedelta(days=365 * 25),  # 25 років тому
...
def test_contact_create_invalid_birthday():
    ...
    invalid_data = {
        ...
        "phone": "0987654321",
        "birthday": date.today() + timedelta(days=1),  # Завтрашня дата
    }
...
def test_contact_create_invalid_phone():
    ...
    invalid_data = {
        ...
        "phone": "abc123",  # Невірний формат
        "birthday": date.today() - timedelta(days=365 * 30),  # 30 років тому
    }
    with pytest.raises(
        ValueError,
